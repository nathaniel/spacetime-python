...
def main() -> int:
    ...
    QApplication.setApplicationName("Spacetime")
    QApplication.setApplicationDisplayName("Spacetime")
    ...
    app.setFont(installed_ui_font())
    window=MainWindow(scenario, path=args.scenario); window.show(); return app.exec()
